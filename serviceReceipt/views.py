...
from serviceReceipt.forms import ItemForm, GenerateReceiptForm, UpdateItemForm
from serviceReceipt.models import Receipt_No, Item, get_receipt_no
...
from productReceipt.decorators import trial_satisfied
...
def generate_receipt(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('serviceReceipt:add_item', receipt.receipt_no)
    ...
    return render(request, 'serviceReceipt/create-receipt.html', context)
...
def all_invoice(request):
    ...
    return render(request, 'serviceReceipt/allreceipt.html', context)
...
def single_invoice(request, id, receipt_no):
    ...
    return render(request, 'serviceReceipt/single_invoice_view.html', context)
...
def add_items(request, receipt_no):
    ...
    return render(request, 'serviceReceipt/item-form.html', context)
...
def receipt_items(request, receipt_no):
    ...
    return render(request, 'serviceReceipt/receipt-items.html', context)
...
def delete_single_item(request, id):
    ...
    return redirect('serviceReceipt:all_items', rn)
...
def approve(request, id):
    ...
    return redirect('serviceReceipt:single_invoice', id, single_receipt.receipt_no)
...
def update_item(request, id):
    ...
    if request.method == "POST":
        ...
        if forms.is_valid():
            ...
            return redirect("serviceReceipt:all_items", item.receipt_no.receipt_no)

    context = {
        "forms": forms,
        "item": item
    }
    return render(request, "serviceReceipt/update_item.html", context)
...
def search(request):
    ...
    if 'keyword' in request.GET and request.GET['keyword'] is not None:
        ...
        return redirect('serviceReceipt:today')
    context = {
        'all_invoice': all_invoice
    }
    return render(request, 'serviceReceipt/allreceipt.html', context)
