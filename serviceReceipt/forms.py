...
from serviceReceipt.models import Receipt_No, Item
...
class ItemForm(forms.ModelForm):
    class Meta:
        model = Item
        fields = ['receipt_no','item_name', 'item_price', 'item_desc']
    def __init__(self, *args, **kwargs):
        ...
        self.fields['item_name'].widget.attrs['placeholder'] = 'Service Offered'
        self.fields['item_price'].widget.attrs['placeholder'] = 'Service Fee' 
        self.fields['item_desc'].widget.attrs['placeholder'] = 'Additional Description'     
